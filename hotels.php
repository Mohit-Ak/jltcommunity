...
<head>
	...
	<meta name="description" content="A list of hotels present at Jumeirah Lakes Towers (JLT) , Sheikh Zayed Road, Dubai, United Arab Emirates (UAE)">
	<meta name="keywords" content="JLT Jumeirah Lakes Towers JLTCommunity JLTCommunity.com hotels hotelApartments lodge motel stay guesthouse Dubai UAE Building Community Society Infrastructure freezone development lakefront business live work play sponsor">
...
<body id="hotelsWrap">
	...
	<div id="container">
		...
		<!-- Begin hotels-page section -->
		<section class="projects-page-section">
				<table id="hotelsData" class="display" width="100%"></table>
		</section>
	...
	<script type="text/javascript" src="js/custom/hotels-data.js"></script>
