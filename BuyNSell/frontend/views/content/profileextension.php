<div class="bg_img">
            	<div class="bg_img_in">
                	<h1><span> <?=_l('List of',$this);?> </span> <?=_l('Ads',$this);?></h1>
                </div>
            </div>
            ...
            <div class="Extensions_bg">
           	<div class="Manage_Description">
            	...
            	<?php } ?>
           		<p style="margin: 10px 5px;"><?=_l('Submit a new Ad',$this);?> <a href="<?php echo base_url(); ?>profile-update-extension"><?=_l('here',$this);?></a>.</p>
            	<table class="list">
			    <thead>
			      <tr>
			        <td class="left"><a href=""><?=_l('Product Name',$this);?></a></td>
			  ...
			  <div style="margin:0px;" class="buttons">
                ...
                <div><?=_l('Your Account',$this);?></div>
                	<ul>
                        ...
                        <li><a class="select" href="<?php echo base_url(); ?>profile-extension"><?=_l('Manage Ads',$this);?> </a></li>
