...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>CONTENT MANAGER - <?php echo $id==""?"Add":"Edit"?> Image of Product</h2>	<p>Ads manager - <?php echo $id==""?"Add":"Edit"?> Image of Product</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
...
<div class="titleh" style="z-index: 710;">
                                	<h3><?php echo $id==""?"Add":"Edit"?> Ads</h3>
                                </div>
