...
<div class="page-title">
     <div class="in">
         <div class="titlebar">	<h2>CONTENT MANAGER - <?php echo $id==""?"Add":"Edit"?> Ads</h2>	<p>Ads manager - <?php echo $id==""?"Add":"Edit"?> Product</p></div>
         <div class="clear"></div>
     </div>
</div>
 <!-- end page title -->
...
<div class="simplebox grid740" style="z-index: 720;margin:0 auto;">
                            	<div class="titleh" style="z-index: 710;">
                                	<h3><?php echo $id==""?"Add":"Edit"?> Product</h3>
                                </div>
                                ...
                                <form action="<?php echo base_url(); ?>backend.php/cpanel/extension_manipulate" method="post" enctype="multipart/form-data" name="edit_user_form" id="edit_user_form" autocomplete="off"  class="form-horizontal form-row-seperated">
                                  	...
                                  	<div class="st-form-line" style="z-index: 680;">	
                                    	<span class="st-labeltext">Product Name</span>	
                                        <input type="text" value="<?php echo isset($banners['name'])?$banners['name']:""; ?>" style="width:510px" id="name" class="st-forminput" name="name" original-title="Ads name to login"> 
                                    ...
                                    <div class="st-form-line">	<span class="st-labeltext">Product Category</span>	
