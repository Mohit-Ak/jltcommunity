...
================================================== -->
   ...
   <div class="tabbable tabs-left">
			...
			<ul class="nav nav-tabs" id="sidemenu">
				...
				<li <?php if($page == "extension") {?>class="active" <?php }?>><a href="<?php echo base_url(); ?>backend.php/cpanel/extensions"><img src="<?php echo base_url(); ?>assets/backend/img/icons/sidemenu/copy.png" width="16" height="16" alt="icon"/>Ads</a></li>
				<li <?php if($page == "category") {?>class="active" <?php }?>><a href="<?php echo base_url(); ?>backend.php/cpanel/category"><img src="<?php echo base_url(); ?>assets/backend/img/catalog.jpg" width="16" height="16" alt="icon"/>Category</a></li>
                   ...
                   <ul class="submenu" style="<?php if($page == "formsetting") {?>display:block;<?php }?>">
                        <li <?php if($title == "extensionsetting") {?>class="active" <?php }?>><a href="<?php echo base_url(); ?>backend.php/cpanel/extensionsetting">Ads Form</a></li>
