...
<head>
	<title>JLTCommunity | buyproperty</title>
...
<body id="buypropertyWrap">
	...
	<div id="container">
		...
		<!-- Begin buyproperty-page section -->
		<section class="projects-page-section">
				<table id="buypropertyData" class="display" width="100%"></table>
		</section>
		<!-- End buyproperty-page section -->
	...
	<script type="text/javascript" src="js/custom/buyproperty-data.js"></script>
