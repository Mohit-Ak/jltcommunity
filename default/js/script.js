...
$(document).ready(function($) {
	...
	/*	Contact Map 2
	/* ---------------------------------------------------------------------- */
	var contact = {"lat":"25.070478", "lon":"55.139018"}; //Change a map coordinate here!
...
/* ---------------------------------------------------------------------- */
function initialize() {
	var bryantPark = new google.maps.LatLng(25.071158,55.139461); //Change a map street view cordinate here! {"lat":"-33.880641", "lon":"151.204298"}
	var panoramaOptions = {
		position: bryantPark,
		pov: {
			heading: 165,
