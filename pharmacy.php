...
<head>
	<title>JLTCommunity | Pharmacy</title>
...
<body id="pharmacyWrap">
	...
	<!--  sponsor slider section -->
				...
				<div class="tp-banner" >
					<ul>	<!-- SLIDE  -->
						<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on"  data-title="Intro Slide">
							<!-- MAIN IMAGE -->
							<img src="upload/slide/life-healthcare-banner.png"  alt="slidebg1" data-lazyload="upload/slide/life-healthcare-banner.png" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
							<!-- LAYERS -->
							...
							<div class="tp-caption finewide_medium_white lfl tp-resizeme rs-parallaxlevel-0"
								...
								style="z-index: 8; max-width: auto; max-height: auto; white-space: nowrap;">LIFE HEALTHCARE GROUP <br><span></span> <br>
							</div>
							<!-- LAYER NR. 1 -->
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="2000" data-saveperformance="on"  data-title="Ken Burns Slide">
							<!-- MAIN IMAGE -->
							<img src="images/dummy.png"  alt="2" data-lazyload="upload/slide/life-healthcare-banner.png" data-bgposition="right top" data-kenburns="on" data-duration="12000" data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="center bottom">
							<!-- LAYERS -->
		...
		<!-- Begin pharmacy-page section -->
		<section class="projects-page-section">
				<table id="pharmacyData" class="display" width="100%"></table>
		</section>
		<!-- End pharmacy-page section -->
	...
	<script type="text/javascript" src="js/custom/pharmacy-data.js"></script>
